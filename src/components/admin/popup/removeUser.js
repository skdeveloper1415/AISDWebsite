            ...
            <div>
                <Dialog header="Header" showHeader={false} style={{ width: '25vw' }} visible={props.visible}
                    ...
                    <div className="flex justify-center items-center gap-4 px-[24px] xl:px-[1.250vw] pb-[24px] xl:pb-[1.250vw]">
                        <div className="bg-[#C81E1E] text-[#FFFFFF] rounded-lg py-[8px] xl:py-[0.417vw] px-[12px] xl:px-[0.625vw] text-[14px] xl:text-[0.729vw] font-medium cursor-pointer" onClick={() => props.onHides(false)}>Yes, I’m sure</div>
