            ...
            {props.data.map((elm) => {
                return (
                    <div key={elm.id} className=''>
                        <div className="rounded-lg bg-[#fff] relative">
                            <div className="flex flex-col bgnewsimage">
                                ...
                                <div className="flex flex-col p-[24px] xl:p-[1.25vw] z-[1]">
                                    ...
                                    <div className="text-[16px] xl:text-[0.833vw] text-[#4B586E] font-normal mb-[16px] xl:mb-[0.833vw] min-h-[148px] xl:min-h-[7.708vw]">
