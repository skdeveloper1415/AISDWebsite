                ...
                <div className=" max-w-md 2xl:max-w-lg md:max-w-md w-full p-2">
                  <form autoComplete="off">
                    ...
                    <div className="flex w-full mt-[26px] xl:mt-[1.354vw] mb-[16px] xl:mb-[0.833vw]">
                      <Link href={'/admin/dashboard'} className="text-[#FFFFFF] text-[16px] xl:text-[0.833vw] bg-[#A93439] hover:bg-[#972c06] rounded-lg w-full text-center py-[12px] xl:py-[0.525vw]">Login</Link>
                    </div>
