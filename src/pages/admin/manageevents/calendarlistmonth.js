...
export default function Index(props) {
    ...
    return (
        <Tabs selectedIndex={activeTab} onSelect={handleTabClick}>
            ...
            <div>
                <TabPanel>
                <div className="full-calendar-sec full-calendar-listmonth bg-white py-[16px] xl:py-[1.25vw] px-[12px] xl:px-[0.833vw] dark:bg-[#13161B]">
                    <FullCalendar 
                        key={updateMonth}
                        plugins={[listPlugin]}
                ...
                <TabPanel>
                <div className="full-calendar-sec bg-white py-[16px] xl:py-[1.25vw] px-[12px] xl:px-[0.833vw] dark:bg-[#13161B]">
                    <FullCalendar 
                        plugins={[listPlugin]}
                        initialView="listMonth"
                        initialDate={firstDate}
